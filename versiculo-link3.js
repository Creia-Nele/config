var BGLinks = (function() {
  ...
  that.updateTooltip = function(tooltip_content) {
    ...
    tooltip.innerHTML = '<div class="bg_popup-header"><div class="bg_popup-header_title"><strong>'+reference_display+' '+tooltip_content.version+'</strong></div></div><div class="bg_popup-content"><div class="bg_popup-content-bible"><p>'+tooltip_content.text+' </p></div></div><div class="bg_popup-footer"><a href="https://creia-nele.blogspot.com" style="font-family: 'PT Serif', serif; font-size: 1em; color:white;">CreiaNele.com<p></p></a></div>';
    addCloseButton(tooltip);
  }
